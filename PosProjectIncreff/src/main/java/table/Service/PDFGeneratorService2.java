...
public class PDFGeneratorService2 {
	...
	public void export(HttpServletResponse response, List<BrandData> list2) throws IOException, DocumentException {
		...
		Paragraph paragraph = new Paragraph("Brand Report", fontTitle);
